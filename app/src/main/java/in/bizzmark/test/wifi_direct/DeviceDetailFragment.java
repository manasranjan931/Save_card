...
package in.bizzmark.test.wifi_direct;
...
public class DeviceDetailFragment extends Fragment implements ConnectionInfoListener {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        SharedPreferences sp = getActivity().getSharedPreferences("CARD_DETAILS", Context.MODE_PRIVATE);
        cardDetails = sp.getString("card_details", "");
    ...
    private void sendData() {
        ...
        serviceIntent.putExtra(FileTransferService.MESSAGE, cardDetails);
